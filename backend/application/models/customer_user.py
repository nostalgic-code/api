...
class CustomerUser(db.Model):
    ...
    password = db.Column(db.String(255))  # For password-based login
    phone = db.Column(db.String(50), unique=True, index=True, nullable=False)  # For OTP
    ...
    approval_eligibility = db.Column(db.JSON)  # Stores validation results for review
