...
def create_app(config_name=None):
    ...
    from application.api.sales_order import sales_order_bp
    ...
    app.register_blueprint(sales_order_bp, url_prefix='/api')  # Prefix defined in blueprint
