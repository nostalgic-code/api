...
def create_customer_user():
    ...
    Request Body:
        {
            ...
            "role": "owner",  // 'owner', 'staff', 'viewer'
            "permission_code": "CR301",
            "permissions": { "orders": true },
            "depot_access": ["DEPOT01", "DEPOT02"]
        }
    ...
    try:
        ...
        required_fields = ['name', 'email', 'password', 'phone', 'customer_code', 'role', 'permission_code']
        ...
        result = admin_service.create_customer_user(
            name=data['name'],
            email=data['email'],
            phone=data['phone'],
